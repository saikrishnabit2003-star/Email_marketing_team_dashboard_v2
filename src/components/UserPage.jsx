...
export function UserPage({ searchTerm }) {
        ...
        if (token) {
            fetch("https://email-marketing-dashboard-v1.vercel.app/users/me/details", {
                ...
                .then(data => {
                    ...
                    const pPct = totalClt > 0 ? (pendingClt / totalClt) * 100 : 0;
                    const rPct = totalClt > 0 ? (partialClt / totalClt) * 100 : 0;
    ...
    useEffect(() => {
        ...
        const mPPct = mTotal > 0 ? (mPendingCount / mTotal) * 100 : 0;
        const mRPct = mTotal > 0 ? (mRejCount / mTotal) * 100 : 0;
    ...
    return (
        <div className={Style.contentpage}>
            ...
            <div className={Style.analysiscontainer}>
                ...
                <div id={Style.overalldetails}>
                    <p>{isDateFilterActive ? 'analysis (selected range)' : 'analysis (current month)'}</p>
                    <div className={Style.container2}>
